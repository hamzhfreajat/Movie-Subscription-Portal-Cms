...
<link rel="stylesheet" type="text/css" href="<?php echo base_url() . 'assets/frontend/' . $selected_theme;?>/hovercss/demo-rtl.css" />
<link rel="stylesheet" type="text/css" href="<?php echo base_url() . 'assets/frontend/' . $selected_theme;?>/hovercss/set1-rtl.css" />
<style>
	.movie_thumb{}
...
<?php
	...
	<div class="row" style="margin:20px 60px;">
		<h4 style="width: 100%;"><?php echo $row['name'];?> <a style="float: left;" href="<?php echo base_url('index.php?browse/movie/'.$row['genre_id']); ?>"><?php echo get_phrase('see_all'); ?></a></h4>
		<div class="content">
			<div class="grid">
				<?php 
