<div class="row">
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="panel widget-flat">
			<div class="panel-body">
				<i class="fa fa-film" style="float: left; font-size: 25px; color: #859ed0;"></i>
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="panel widget-flat">
			<div class="panel-body">
				<i class="fa fa-ticket" style="float: left; font-size: 25px; color: #859ed0;"></i>
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="panel widget-flat">
			<div class="panel-body">
			<div class="panel-body">
				<i class="fa fa-television" style="float: left; font-size: 25px; color: #859ed0;"></i>
...
<div class="row">
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="panel widget-flat">
			<div class="panel-body">
				<i class="fa fa-user" style="float: left; font-size: 25px; color: #859ed0;"></i>
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="panel widget-flat">
			<div class="panel-body">
				<i class="fa fa-subscript" style="float: left; font-size: 25px; color: #859ed0;"></i>
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="panel widget-flat">
			<div class="panel-body">
				<i class="fa fa-shopping-cart" style="float: left; font-size: 25px; color: #859ed0;"></i>
