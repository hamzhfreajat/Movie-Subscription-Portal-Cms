    	...
    	<form method="post" action="<?php echo base_url();?>index.php?admin/movie_edit/<?php echo $movie_id;?>" enctype="multipart/form-data">
	        <div class="panel panel-primary">
	            ...
	            <div class="panel-body">
					...
					<div class="form-group mb-3">
						<label for="is_trendy">Mark it as a trendy movie</label><br>
						<input type="checkbox" id="is_trendy" name="is_trendy" value="1" <?php if ( $movie_detail->is_trendy == 1)echo 'checked'; ?>>
