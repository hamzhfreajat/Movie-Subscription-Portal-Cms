		...
		<form method="post" action="<?php echo base_url();?>index.php?admin/movie_create" enctype="multipart/form-data">
	        <div class="panel panel-primary">
	        	<div class="panel-heading">
	        		<div class="panel-title">انشاء فيلم</div>
	        	</div>
	            <div class="panel-body">
					<div class="form-group mb-3">
	                    <label for="simpleinput1">اسم الفيلم</label>
	                    <input type="text" class="form-control" id = "simpleinput1" name="title" required>
	                </div>
					<div class="form-group mb-3">
	                    <label for="url">رابط اعلان الفيلم</label>
					...
					<div class="form-group mb-3">
	                    <label for="url">رابط الفيلم</label>
						<span class="help">- youtube or any hosted video</span>
					...
					<div class="form-group mb-3">
	                    <label for="">صورة بانر للفيلم</label>
					...
					<div class="form-group mb-3">
						<label for="description_long">الوصف الطويل</label>
						<textarea class="form-control" id="description_long" name="description_long" rows="6"></textarea>
					</div>

					<div class="form-group mb-3">
						<label for="description_short">الوصف القصير</label>
					...
					<div class="form-group mb-3">
						<label for="actors">الممثلين</label>
					...
					<div class="form-group mb-3">
						<label for="genre_id">النوع</label>
					...
					<div class="form-group mb-3">
						<label for="featured">هل هو مميز ؟</label>
					...
					<div class="form-group mb-3">
						<label for="is_trendy">هل هو تريند ؟</label><br>
						<input type="checkbox" id="is_trendy" name="is_trendy" value="1">
						<label for="is_trendy">Trendy movie</label>
					</div>
